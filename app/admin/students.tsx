...
export default function AdminStudents() {
    ...
    const [programs] = useState([
        ...
        { id: "2", programName: "Information Technology" },
    ...
    const handleChangeSemester = (newSemester: string) => {
        ...
        // Logic to update data based on new semester
    };
    ...
    // Making these consistent between header and rows
    const columnWidths = {
        studentId: 120,
        name: 150,
        email: 200,
            ...
            <ScrollView style={styles.content}>
                            ...
                            <View style={styles.tableBody}>
                                {filteredStudents.map((student) => (
                                    <View key={student.id} style={styles.tableRow}>
                                        <Text style={[styles.tableCell, { width: columnWidths.studentId }]} numberOfLines={1}>{student.studentId}</Text>
                                        <Text style={[styles.tableCell, { width: columnWidths.name }]} numberOfLines={1}>{student.name}</Text>
                                        <Text style={[styles.tableCell, { width: columnWidths.email }]} numberOfLines={1}>{student.email}</Text>
                                        <Text style={[styles.tableCell, { width: columnWidths.phone }]} numberOfLines={1}>{student.phone}</Text>
                                        <Text style={[styles.tableCell, { width: columnWidths.program }]} numberOfLines={1}>{student.program}</Text>
                ...
                <View style={styles.statsContainer}>
                    ...
                    <View style={styles.statCard}>
                        ...
                        <Text style={styles.statNumber}>{inactiveStudents}</Text>
                    ...
                    <View style={styles.modalContainer}>
                        <View style={styles.modalHeader}>
                            <Text style={styles.modalTitle}>
                                {isAddUser ? 'Add New Student' : 'Edit Student'}
                            </Text>
...
const styles = StyleSheet.create({
    ...
    // New table styles with consistent widths
    tableContainer: {
        borderRadius: 8,
        marginBottom: 16,
        overflow: 'hidden',
